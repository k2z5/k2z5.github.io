          ...
          <div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12 text-center">
            <div class="callback">
              ...
              <div class="row">
                ...
                <div class="col-sm-2 col-xs-12">
                  <input type="text" name="name" placeholder="фамилия" autocomplete="off" value="" class="input-name" pattern=".{3,}">
                </div>
                <div class="col-sm-2 col-xs-12">
                  <input type="text" name="name" placeholder="компания" autocomplete="off" value="" class="input-name" pattern=".{3,}">
                </div>
                <div class="col-sm-2 col-xs-12">
                  <input type="text" name="name" placeholder="должность" autocomplete="off" value="" class="input-name" pattern=".{3,}">
                </div>
                <div class="col-sm-2 col-xs-12">
                  <input type="text" name="name" placeholder="мейл" autocomplete="off" value="" class="input-name" pattern=".{3,}">
                </div>
                <div class="col-sm-2 col-xs-12">
              ...
              <br>
               <div class="row">
                <div class="col-sm-8 col-xs-12">
                  <input type="text" placeholder="комментарии" autocomplete="off" value="" class="input-name" pattern=".{3,}">
                </div>
